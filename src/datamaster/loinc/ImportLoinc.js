...
const ENDPOINTS = {
  import_loinc: 'http://18.142.73.75:5000/api/v3/datamaster/loinc/import', // Sesuaikan dengan endpoint import
};
...
export function importLOINC() {
  const regisUrl = `${ENDPOINTS.import_loinc}`;
