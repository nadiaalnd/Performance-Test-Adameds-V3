...
const ENDPOINTS = {
  create_faskes: 'http://18.142.73.75:5000/api/v3/datamaster/faskes',
};
...
function generateUniqueCode() {
    return `faskes-${Math.floor(Math.random() * 100000)}`;
  }

// Request Body 
export function postFASKES() {
  ...
  const regisUrl = ENDPOINTS.create_faskes;
